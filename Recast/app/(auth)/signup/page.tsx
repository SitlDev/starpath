        ...
        <div className="min-h-screen bg-base flex flex-col items-center justify-center p-6">
            <div className="w-full max-w-md space-y-8">
                <div className="text-center space-y-2">
                    <Link href="/" className="text-4xl font-black italic uppercase tracking-tighter font-syne inline-block">
                        RECAST
                    </Link>
                ...
                <div className="card p-8">
                    <form onSubmit={handleSignup} className="space-y-6">
                        <div className="space-y-2">
                            <label className="block text-[10px] font-mono uppercase tracking-widest text-text-muted ml-1">
                                Email
                            </label>
                            <input
                                type="email"
                        ...
                        {error && (
                            <p className="text-error text-xs font-mono uppercase tracking-widest text-center">
                                {error}
                            </p>
                        )}
                    ...
                    <button
                        ...
                        disabled={loading}
                        className="btn-secondary w-full py-4 flex items-center justify-center gap-3 font-mono text-sm tracking-widest uppercase hover:bg-base transition-colors"
                    >
