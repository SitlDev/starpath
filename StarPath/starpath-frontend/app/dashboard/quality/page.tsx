  ...
  if (!user) {
    return (
      <div className="p-8 text-center">
        <p className="text-slate-300">Please log in to access quality measures.</p>
      </div>
    );
  }
    ...
    <div className="min-h-screen bg-slate-900 px-4 sm:px-6 lg:px-8 py-8">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="flex items-center gap-3 mb-2">
          ...
          <h1 className="text-3xl sm:text-4xl font-bold text-white">Quality Measures</h1>
        </div>
        <p className="text-slate-400 text-lg mb-8">Track CMS Five-Star Quality Reporting Program (QRP) measures and benchmark against state and national averages</p>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 mb-8">
          ...
          <div className="group relative">
            ...
            <div className="relative bg-slate-800 border border-slate-700 rounded-2xl p-6 hover:border-slate-600 transition-all duration-300">
              <div className="flex items-center justify-between mb-3">
                <span className="text-xs font-semibold text-slate-400 uppercase tracking-wide">Above State Avg</span>
                <div className="p-2 bg-slate-700 rounded-lg">
              ...
              <div className="text-4xl font-bold text-green-400">{stats.aboveAverage}</div>
          ...
          <div className="group relative">
            ...
            <div className="relative bg-slate-800 border border-slate-700 rounded-2xl p-6 hover:border-slate-600 transition-all duration-300">
              <div className="flex items-center justify-between mb-3">
                <span className="text-xs font-semibold text-slate-400 uppercase tracking-wide">National Benchmark</span>
                <div className="p-2 bg-slate-700 rounded-lg">
              ...
              <div className="text-4xl font-bold text-blue-400">{stats.atOrAboveNational}</div>
          ...
          <div className="group relative">
            ...
            <div className="relative bg-slate-800 border border-slate-700 rounded-2xl p-6 hover:border-slate-600 transition-all duration-300">
              <div className="flex items-center justify-between mb-3">
                <span className="text-xs font-semibold text-slate-400 uppercase tracking-wide">Total Tracked</span>
                <div className="p-2 bg-slate-700 rounded-lg">
              ...
              <div className="text-4xl font-bold text-purple-400">{stats.totalMeasures}</div>
        ...
        {loading ? (
          <div className="flex justify-center items-center py-16">
            <div className="space-y-4 text-center">
              ...
              <p className="text-slate-300 font-medium">Loading quality measures...</p>
            </div>
          </div>
        ) : measures.length === 0 ? (
          <div className="flex justify-center items-center py-16">
            <div className="text-center">
              ...
              <p className="text-slate-300 font-medium">No quality measures available</p>
              ...
              <div key={idx} className="bg-slate-800 border border-slate-700 rounded-2xl p-6 hover:border-slate-600 transition-all duration-300">
                <div className="flex flex-col md:flex-row md:items-start md:justify-between gap-4 mb-4">
                  <div className="flex-1">
                    <h3 className="text-lg font-bold text-white">{measure.measure_name}</h3>
                    <p className="text-sm text-slate-400 mt-1">Reporting Period: {measure.reporting_period}</p>
                  </div>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                  <div className="bg-slate-700 bg-opacity-50 rounded-lg p-4 border border-slate-600">
                    <div className="text-xs font-semibold text-slate-400 uppercase tracking-wide">Facility Score</div>
                    <div className="text-2xl font-bold text-blue-400 mt-2">{measure.facility_score.toFixed(1)}%</div>
                    <div className="text-xs text-slate-500 mt-1">Your facility</div>
                  </div>

                  <div className="bg-slate-700 bg-opacity-50 rounded-lg p-4 border border-slate-600">
                    <div className="text-xs font-semibold text-slate-400 uppercase tracking-wide">State Average</div>
                    <div className="text-2xl font-bold text-slate-300 mt-2">{measure.state_average.toFixed(1)}%</div>
                    <div className="text-xs text-slate-500 mt-1">
                      {measure.facility_score > measure.state_average ? (
                        <span className="text-green-400 font-semibold">↑ Above</span>
                      ) : measure.facility_score < measure.state_average ? (
                        <span className="text-red-400 font-semibold">↓ Below</span>
                      ) : (
                        <span className="text-slate-400">Equal to</span>
                      )}
                    </div>
                  </div>

                  <div className="bg-slate-700 bg-opacity-50 rounded-lg p-4 border border-slate-600">
                    <div className="text-xs font-semibold text-slate-400 uppercase tracking-wide">National Average</div>
                    <div className="text-2xl font-bold text-slate-300 mt-2">{measure.national_average.toFixed(1)}%</div>
                    <div className="text-xs text-slate-500 mt-1">
                ...
                <div className="mt-4">
                  <div className="flex items-center justify-between mb-2">
                    <span className="text-xs font-semibold text-slate-400">Performance Range</span>
        ...
        <div className="bg-slate-800 rounded-2xl border border-slate-700 p-6 mt-8">
          <h3 className="font-bold text-white mb-3 text-lg">Comparison Indicators</h3>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-sm">
            <div className="flex items-center gap-3">
              <span className="inline-flex items-center justify-center w-6 h-6 bg-slate-700 text-green-400 rounded-full font-bold text-xs">↑</span>
              <span className="text-slate-300"><span className="font-semibold">Better</span> — Performing above state average</span>
            </div>
            <div className="flex items-center gap-3">
              <span className="inline-flex items-center justify-center w-6 h-6 bg-slate-700 text-slate-400 rounded-full font-bold text-xs">→</span>
              <span className="text-slate-300"><span className="font-semibold">Same</span> — Meeting benchmark target</span>
            </div>
            <div className="flex items-center gap-3">
              <span className="inline-flex items-center justify-center w-6 h-6 bg-slate-700 text-red-400 rounded-full font-bold text-xs">↓</span>
              <span className="text-slate-300"><span className="font-semibold">Worse</span> — Below state average</span>
            </div>
          </div>
        </div>
      </div>
