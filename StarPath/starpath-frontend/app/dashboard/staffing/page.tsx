...
export default function StaffingPage() {
  ...
  const getStatusColor = (value: number, benchmark: number) => {
    if (value >= benchmark * 1.1) return 'text-green-600 bg-green-900 bg-opacity-20';
    if (value >= benchmark) return 'text-blue-600 bg-blue-900 bg-opacity-20';
    if (value >= benchmark * 0.9) return 'text-yellow-600 bg-yellow-900 bg-opacity-20';
    return 'text-red-600 bg-red-900 bg-opacity-20';
  };
  ...
  if (!user) {
    return (
      <div className="p-8 text-center">
        <p className="text-slate-700">Please log in to access staffing information.</p>
      </div>
    );
  }
      ...
      <main className="flex-1 overflow-auto">
        ...
        <div className="mb-10">
          <div className="flex items-center gap-3 mb-2">
            ...
            <h1 className="text-3xl sm:text-4xl font-bold text-slate-900">Staffing Levels</h1>
          </div>
        ...
        <div className="bg-white border border-slate-200 rounded-2xl p-6 mb-8">
          <div className="flex items-center gap-2 mb-3">
            ...
            <h3 className="font-bold text-slate-900">CMS National Benchmarks (Hours per Resident Day)</h3>
          </div>
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 mt-4">
            <div className="bg-slate-100 bg-opacity-50 rounded-lg p-4 border border-slate-300">
              <div className="text-xs font-semibold text-slate-600 uppercase tracking-wide">Registered Nurses (RN)</div>
              <div className="text-3xl font-bold text-emerald-600 mt-2">{benchmarks.rn}</div>
              <div className="text-xs text-slate-500 mt-1">Hours per resident day</div>
            </div>
            <div className="bg-slate-100 bg-opacity-50 rounded-lg p-4 border border-slate-300">
              <div className="text-xs font-semibold text-slate-600 uppercase tracking-wide">Licensed Nurses (LN)</div>
              <div className="text-3xl font-bold text-teal-600 mt-2">{benchmarks.ln}</div>
              <div className="text-xs text-slate-500 mt-1">Hours per resident day</div>
            </div>
            <div className="bg-slate-100 bg-opacity-50 rounded-lg p-4 border border-slate-300">
              <div className="text-xs font-semibold text-slate-600 uppercase tracking-wide">Nursing Aides</div>
              <div className="text-3xl font-bold text-cyan-600 mt-2">{benchmarks.aide}</div>
              <div className="text-xs text-slate-500 mt-1">Hours per resident day</div>
            </div>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
          <div className="group relative">
            ...
            <div className="relative bg-white border border-slate-200 rounded-2xl p-6 hover:border-slate-300 transition-all duration-300">
              <div className="flex items-center justify-between mb-3">
                <span className="text-xs font-semibold text-slate-600 uppercase tracking-wide">Avg RN Staffing</span>
                <div className="p-2 bg-slate-100 rounded-lg">
              ...
              <div className="text-4xl font-bold text-blue-600">{stats.averageRN}</div>
          ...
          <div className="group relative">
            ...
            <div className="relative bg-white border border-slate-200 rounded-2xl p-6 hover:border-slate-300 transition-all duration-300">
              <div className="flex items-center justify-between mb-3">
                <span className="text-xs font-semibold text-slate-600 uppercase tracking-wide">Avg LN Staffing</span>
                <div className="p-2 bg-slate-100 rounded-lg">
          ...
          <div className="group relative">
            ...
            <div className="relative bg-white border border-slate-200 rounded-2xl p-6 hover:border-slate-300 transition-all duration-300">
              <div className="flex items-center justify-between mb-3">
                <span className="text-xs font-semibold text-slate-600 uppercase tracking-wide">Avg Aide Staffing</span>
                <div className="p-2 bg-slate-100 rounded-lg">
              ...
              <div className="text-4xl font-bold text-cyan-600">{stats.averageAide}</div>
              <div className="mt-3 text-xs text-slate-500">per resident day</div>
            </div>
          </div>
          ...
          <div className="group relative">
            ...
            <div className="relative bg-white border border-slate-200 rounded-2xl p-6 hover:border-slate-300 transition-all duration-300">
              <div className="flex items-center justify-between mb-3">
                <span className="text-xs font-semibold text-slate-600 uppercase tracking-wide">Above Average</span>
                <div className="p-2 bg-slate-100 rounded-lg">
              ...
              <div className="text-4xl font-bold text-green-600">{stats.facilitiesAboveAverage}</div>
        ...
        {loading ? (
          <div className="flex justify-center items-center py-16">
            <div className="space-y-4 text-center">
              ...
              <p className="text-slate-700 font-medium">Loading staffing data...</p>
            </div>
          </div>
        ) : staffing.length === 0 ? (
          <div className="flex justify-center items-center py-16">
            <div className="text-center">
              ...
              <p className="text-slate-700 font-medium">No staffing data available</p>
            ...
            {staffing.map((item, idx) => (
              <div key={idx} className="bg-white border border-slate-200 rounded-2xl p-6 hover:border-slate-300 transition-all duration-300">
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-4">
                  <div>
                    <span className="text-xs font-semibold text-slate-600 uppercase tracking-wide">Facility</span>
                    <div className="font-bold text-slate-900 mt-2">{item.facility_id}</div>
                  </div>
                  <div>
                    <span className="text-xs font-semibold text-slate-600 uppercase tracking-wide">RN Staffing</span>
                  ...
                  <div>
                    <span className="text-xs font-semibold text-slate-600 uppercase tracking-wide">LN Staffing</span>
                  ...
                  <div>
                    <span className="text-xs font-semibold text-slate-600 uppercase tracking-wide">Aide Staffing</span>
                ...
                <div className="flex items-center justify-between pt-4 border-t border-slate-200">
                  ...
                  <span className={`inline-flex items-center px-3 py-1.5 rounded-full text-sm font-semibold ${
                    item.staffing_score >= 4
                      ...
                      ? 'bg-blue-900 bg-opacity-20 text-blue-600'
            ...
            <div className="overflow-x-auto">
              <table className="w-full text-sm">
                <thead className="bg-slate-100 border-b border-slate-300">
                  <tr>
                    <th className="px-6 py-4 text-left font-semibold text-slate-700">Facility</th>
                    <th className="px-6 py-4 text-center font-semibold text-slate-700">RN Staffing</th>
                    <th className="px-6 py-4 text-center font-semibold text-slate-700">vs Benchmark</th>
                    <th className="px-6 py-4 text-center font-semibold text-slate-700">LN Staffing</th>
                    <th className="px-6 py-4 text-center font-semibold text-slate-700">vs Benchmark</th>
                    <th className="px-6 py-4 text-center font-semibold text-slate-700">Aide Staffing</th>
                    <th className="px-6 py-4 text-center font-semibold text-slate-700">vs Benchmark</th>
                  </tr>
                </thead>
                <tbody>
                  {staffing.map((item, idx) => (
                    <tr key={idx} className="border-b border-slate-200 hover:bg-slate-100 hover:bg-opacity-50">
                      <td className="px-6 py-4 font-medium text-slate-700">{item.facility_id}</td>
                      <td className="px-6 py-4 text-center text-slate-700">{item.rn_staffing.toFixed(2)}</td>
                      <td className="px-6 py-4 text-center">
                        <span className={`inline-block px-2.5 py-1 rounded-lg text-xs font-semibold ${
                          item.rn_staffing >= benchmarks.rn ? 'bg-green-900 bg-opacity-20 text-green-600' : 'bg-red-900 bg-opacity-20 text-red-600'
                        }`}>
                          {((item.rn_staffing / benchmarks.rn - 1) * 100).toFixed(0)}%
                        </span>
                      </td>
                      <td className="px-6 py-4 text-center text-slate-700">{item.ln_staffing.toFixed(2)}</td>
                      <td className="px-6 py-4 text-center">
                        <span className={`inline-block px-2.5 py-1 rounded-lg text-xs font-semibold ${
                          item.ln_staffing >= benchmarks.ln ? 'bg-green-900 bg-opacity-20 text-green-600' : 'bg-red-900 bg-opacity-20 text-red-600'
                        }`}>
                          {((item.ln_staffing / benchmarks.ln - 1) * 100).toFixed(0)}%
                        </span>
                      </td>
                      <td className="px-6 py-4 text-center text-slate-700">{item.aide_staffing.toFixed(2)}</td>
                      <td className="px-6 py-4 text-center">
                        <span className={`inline-block px-2.5 py-1 rounded-lg text-xs font-semibold ${
                          item.aide_staffing >= benchmarks.aide ? 'bg-green-900 bg-opacity-20 text-green-600' : 'bg-red-900 bg-opacity-20 text-red-600'
                        }`}>
